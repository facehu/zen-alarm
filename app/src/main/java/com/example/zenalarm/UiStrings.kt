...
object UiStrings {
    fun toJson(context: Context): String {
        ...
        val scalarKeys = listOf(
            ...
            "ui_group_alarm_volume" to R.string.ui_group_alarm_volume,
            "ui_group_alarm_volume_hint" to R.string.ui_group_alarm_volume_hint,
            "ui_volume_ramp_seconds" to R.string.ui_volume_ramp_seconds,
            "ui_volume_ramp_hint" to R.string.ui_volume_ramp_hint,
            "ui_group_alarm_volume_system" to R.string.ui_group_alarm_volume_system,
            "ui_group_alarm_volume_percent" to R.string.ui_group_alarm_volume_percent,
            ...
            "ui_settings_version" to R.string.ui_settings_version,
            "ui_settings_build_time" to R.string.ui_settings_build_time,
            ...
            "ui_group_meta_alarm_volume" to R.string.ui_group_meta_alarm_volume,
